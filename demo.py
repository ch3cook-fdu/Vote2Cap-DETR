...
def make_args_parser():
    ...
    parser.add_argument(
        "--detector", default="detector_votenet_decoder", type=str, 
...
def run_dense_caption(args, model, dataset_loader):
    ...
    for curr_iter, batch_data_label in enumerate(tqdm(dataset_loader)):
        ...
        # ---- calculate object assignment for easier comparison
        ...
        for idx, scene_id in enumerate(batch_data_label["scan_idx"].cpu().tolist()):
            ...
            for prop_id in range(nqueries):
                ...
                scene_results.append({
                    'estimated_object_id': match_box_idxs[idx][prop_id],
            ...
            with open(output_file, 'w') as file:
                json.dump(scene_results, file, indent=4)
    return
